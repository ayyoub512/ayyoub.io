							...
							<div>
								<a
									...
									onMouseOver={(e) => {
										...
										e.currentTarget.style.boxShadow = "0 30px 50px -10px rgba(255,255,255,0.5)";
									}}
									onMouseOut={(e) => {
										e.currentTarget.style.transform = "translateY(0) scale(1)";
										e.currentTarget.style.boxShadow = "0 20px 40px -10px rgba(255,255,255,0.3)";
									}}>
									Say Hello
									<svg

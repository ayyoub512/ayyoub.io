		...
		<>
					...
					<div
						...
						<div style={{ position: "relative", zIndex: 2 }}>
							...
							<p style={{ margin: "0 auto 3rem auto", fontSize: "1.2rem", color: "rgba(255,255,255,0.8)", lineHeight: "1.7", maxWidth: "600px" }}>
								I&apos;m currently looking for new opportunities. Whether you have a question, a project idea, or just want to say hi, my inbox is always open. Let&apos;s build
								something beautiful.
							</p>
							...
							<div className="contact-links-grid">
								...
								<a href="https://github.com/ayyoub512" target="_blank" rel="noopener noreferrer" className="contact-link">
									<span style={{ fontSize: "1.8rem" }}>
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 250" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
											<g>
												<path
													fill="#ffffff"
			...
			<footer style={{ padding: "2rem 0", textAlign: "center", borderTop: "1px solid var(--card-border)" }}>
				<p style={{ fontSize: "0.9rem", color: "var(--text-secondary)" }}>
					Designed & Built with ❤️ by Ayyoub.
					<br />
				</p>
			</footer>
		</>

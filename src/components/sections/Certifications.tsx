		...
		<section id="certifications" className="section" style={{ position: "relative", zIndex: 10 }}>
			...
			<div className="container">
				<h2 className="animate-fade-in">
					<span className="text-gradient">03.</span> Awards & Certifications
				</h2>
				<div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "2rem" }}>
					<div className="card animate-fade-in delay-2" style={{ display: "flex", gap: "1.5rem", alignItems: "center" }}>
						...
						<div style={{ flexGrow: 1 }}>
							...
							<a
								href="https://cp.certmetrics.com/amazon/en/public/verify/credential/f5c29803599046b8a0267e0bbc9dcde0"
								className="badge"
								target="_blank"
					...
					<div className="card animate-fade-in delay-1" style={{ display: "flex", gap: "1.5rem", alignItems: "center" }}>
						...
						<div>
							...
							<a
								href="https://www.stlawrencecollege.ca/news/slc-students-win-big-at-provincial-skills-competition"
								className="badge"
								target="_blank"
								style={{ marginTop: "0.5rem", display: "inline-block" }}>
								Read Article ↗
